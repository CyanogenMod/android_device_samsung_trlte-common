...
public class TrlteDozeService extends Service {
    private static final String TAG = "TrlteDozeService";
    ...
    class TrlteProximitySensor implements SensorEventListener {
        ...
        public TrlteProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "TrlteDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new TrlteProximitySensor(mContext);
